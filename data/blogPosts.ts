...
export const blogPostsData: BlogPostData[] = [
  {
    ...
    metaTitle: "OG Hücre Sistemleri ve Seçim Kriterleri | Novatek Enerji",
    ...
    metaTitleEn: "Medium Voltage Switchgear Selection Guide | Novatek Enerji",
    ...
    metaTitleRu: "Руководство по выбору ячеек СН | Novatek Enerji",
    metaDescRu: "Сравнение КРУ среднего напряжения: Metal-Clad, КРУЭ (GIS) и RMU. Классы безопасности LSC2A/LSC2B и инженерные рекомендации Novatek Enerji."
  },
  {
    ...
    metaTitle: "PLC ve SCADA Otomasyonu ile Sıfır Duruş Stratejileri | Novatek Enerji",
    ...
    metaTitleEn: "Industrial PLC & SCADA Zero-Downtime Solutions | Novatek Enerji",
    ...
    metaTitleRu: "Автоматизация PLC и SCADA: Стратегия непрерывной работы | Novatek Enerji",
  ...
  },
  {
    ...
    metaTitle: "Trafo Merkezi Kurulum Standartları ve Bakım Rehberi | Novatek Enerji",
    ...
    metaTitleEn: "Industrial Transformer Substation Standards | Novatek Enerji",
    ...
    metaTitleRu: "Проектирование и монтаж ТП и КТП | Novatek Enerji",
  ...
  },
  {
    ...
    metaTitle: "Çatı GES Kurulumunda Mühendislik Hesapları | Novatek Enerji",
    ...
    metaTitleEn: "Industrial Rooftop Solar PV Engineering Guide | Novatek Enerji",
    ...
    metaTitleRu: "Инжиниринг кровельных СЭС для промышленных объектов | Novatek Enerji",
  ...
  },
  {
    ...
    metaTitle: "Kompanzasyon Panoları ve Reaktif Güç Yönetimi | Novatek Enerji",
    ...
    metaTitleEn: "Power Factor Correction & Harmonic Filtering Guide | Novatek Enerji",
    ...
    metaTitleRu: "Компенсация реактивной мощности и фильтрация гармоник | Novatek Enerji",
  ...
  },
  {
    ...
    metaTitle: "Elektrik Taahhüt Süreci ve Mühendislik Adımları | Novatek Enerji",
    ...
    metaTitleEn: "Turnkey Electrical EPC Contracting Guide | Novatek Enerji",
    ...
    metaTitleRu: "Электромонтажные работы «под ключ» (EPC) | Novatek Enerji",
  ...
  },
  {
    ...
    metaTitle: "Sanayide Enerji Verimliliği ve ISO 50001 | Novatek Enerji",
    ...
    metaTitleEn: "Industrial Energy Efficiency & ISO 50001 Guide | Novatek Enerji",
    ...
    metaTitleRu: "Промышленная энергоэффективность и ISO 50001 | Novatek Enerji",
  ...
  },
  {
    ...
    metaTitle: "Kablo Taşıma ve Yangın Dayanımlı Kablolama Standartları | Novatek Enerji",
    ...
    metaTitleEn: "Industrial Cable Trays & Fire-Resistant Cabling | Novatek Enerji",
    ...
    metaTitleRu: "Огнестойкие кабельные линии и кабеленесущие системы | Novatek Enerji",
  ...
  },
  {
    ...
    metaTitle: "Topraklama ve Yıldırımdan Korunma Sistemleri | Novatek Enerji",
    ...
    metaTitleEn: "Industrial Grounding & Lightning Protection Guide | Novatek Enerji",
    ...
    metaTitleRu: "Промышленное заземление и молниезащита | Novatek Enerji",
  ...
  },
  {
    ...
    metaTitle: "Arazi Tipi GES Kurulumu ve Şebeke Bağlantısı | Novatek Enerji",
    ...
    metaTitleEn: "Utility-Scale Ground Solar PV Engineering Guide | Novatek Enerji",
    ...
    metaTitleRu: "Проектирование наземных СЭС большой мощности | Novatek Enerji",
